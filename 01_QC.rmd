...
```{r}
path <- '~/scratch/lachlan/Utz/data/C11_continuous/cellranger/outs/per_sample_outs/cellranger/count/sample_filtered_feature_bc_matrix/'
counts <- Read10X(path)
seu_c11 <- CreateSeuratObject(counts$`Gene Expression`, min.cells = 3, project =  "c11_continuous")
...
cc1 <- table(seu_c11$HTO2_classification.global)
...
tcr_c11 <- read.csv("~/scratch/lachlan/Utz/data/C11_continuous/cellranger/outs/per_sample_outs/cellranger/vdj_t/filtered_contig_annotations.csv")
...
```{r}
path <- '~/scratch/lachlan/Utz/data/C41_continuous/cellranger/outs/per_sample_outs/cellranger/count/sample_filtered_feature_bc_matrix/'
counts <- Read10X(path)
seu_c41 <- CreateSeuratObject(counts$`Gene Expression`, min.cells = 3, project =  "c41_continuous")

seu_c41[['HTO']] <- CreateAssayObject(counts$`Antibody Capture`)
seu_c41[['HTO2']] <- CreateAssayObject(counts$`Antibody Capture`[10:11,])
```
...
cc4 <- table(seu_c41$HTO2_classification.global)
...
tcr_c41 <- read.csv("~/scratch/lachlan/Utz/data/C41_continuous/cellranger/outs/per_sample_outs/cellranger/vdj_t/filtered_contig_annotations.csv")

contig_list <- createHTOContigList(tcr_c41, seu_c41, group.by = 'HTO2_classification', multi.run = T)

comb <- combineTCR(contig_list, samples = c("C0304-Hashtag-4", "C0305-Hashtag-5"), filterMulti = T )
...
```
```{r}
path <- '~/scratch/lachlan/Utz/data/C71_continuous/cellranger/outs/per_sample_outs/cellranger/count/sample_filtered_feature_bc_matrix/'
counts <- Read10X(path)
seu_c71 <- CreateSeuratObject(counts$`Gene Expression`, min.cells = 3, project =  "c71_continuous")

seu_c71[['HTO']] <- CreateAssayObject(counts$`Antibody Capture`)
seu_c71[['HTO2']] <- CreateAssayObject(counts$`Antibody Capture`[7:12,])
```
...
cc7 <- table(seu_c71$HTO2_classification.global)
...
tcr_c71 <- read.csv("~/scratch/lachlan/Utz/data/C71_continuous/cellranger/outs/per_sample_outs/cellranger/vdj_t/filtered_contig_annotations.csv")
...
```{r}
path <- '~/scratch/lachlan/Utz/data/T11_continuous/cellranger/outs/per_sample_outs/cellranger/count/sample_filtered_feature_bc_matrix/'
counts <- Read10X(path)
seu_t11 <- CreateSeuratObject(counts$`Gene Expression`, min.cells = 3, project =  "t11_continuous")
...
tc1 <- table(seu_t11$HTO2_classification.global)
...
tcr_t11 <- read.csv("~/scratch/lachlan/Utz/data/T11_continuous/cellranger/outs/per_sample_outs/cellranger/vdj_t/filtered_contig_annotations.csv")
...
```{r}
path <- '~/scratch/lachlan/Utz/data/T41_continuous/cellranger/outs/per_sample_outs/cellranger/count/sample_filtered_feature_bc_matrix/'
counts <- Read10X(path)
seu_t41 <- CreateSeuratObject(counts$`Gene Expression`, min.cells = 3, project =  "t41_continuous")
...
tc4 <- table(seu_t41$HTO2_classification.global)
...
tcr_t41 <- read.csv("~/scratch/lachlan/Utz/data/T41_continuous/cellranger/outs/per_sample_outs/cellranger/vdj_t/filtered_contig_annotations.csv")
...
```{r}
path <- '~/scratch/lachlan/Utz/data/T71_continuous/cellranger/outs/per_sample_outs/cellranger/count/sample_filtered_feature_bc_matrix/'
counts <- Read10X(path)
seu_t71 <- CreateSeuratObject(counts$`Gene Expression`, min.cells = 3, project =  "t71_continuous")

seu_t71[['HTO']] <- CreateAssayObject(counts$`Antibody Capture`)
seu_t71[['HTO2']] <- CreateAssayObject(counts$`Antibody Capture`[7:12,])
```
```{r}
...
tc7 <- table(seu_t71$HTO2_classification.global)
...
tcr_t71 <- read.csv("~/scratch/lachlan/Utz/data/T71_continuous/cellranger/outs/per_sample_outs/cellranger/vdj_t/filtered_contig_annotations.csv")
...
```
```{r}
saveRDS(seu, "../output/filtered_continuous.rds")
```
